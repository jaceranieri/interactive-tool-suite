/* ==========================================================================
   ...
   Authoring-only concerns (add/rename/delete/reorder tabs) live entirely
   outside this file, in index.html's Tabs drawer — this module only ever
   renders tabs + reports which one was clicked.
   ========================================================================== */
 ...
 */
function renderTabNav(container, { tabs, activeTabId, onSelect }) {
  container.innerHTML = '';
