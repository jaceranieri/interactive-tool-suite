...
const PAGES = {
  ...
  // 'tabbed-panels': { file: 'TabbedPanels', title: 'Tabbed Panels', description: 'Build tabbed content with headings, text, lists, and linking buttons.', status: 'in development' },  <- uncomment once AppScript/TabbedPanels.html + its Js.html modules exist (see CLAUDE.md's deployment pipeline)
